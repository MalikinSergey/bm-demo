            ...
            <div class="card-wrap">
                ...
                @if(session()->get('from_url'))
                    ...
                    <div class="card-alert">
                        <p>
                            Hola! Before we can give you the opportunity to make this purchase, <br> you need to register at our site.

                        </p>

                        <p>it's simple and fast. After registering, we return you to
...
{{--                        <p>--}}
{{--                            If you want to buy something in our market - you need to be registered.--}}
{{--                        </p>--}}

{{--                        <p>--}}
{{--                            We do not send promotions without your permission and do not share your e-mail with third parties.--}}
{{--                        </p>--}}
{{--                    </div>--}}
                        ...
                        <form action="{{route('website.user.register')}}" method="post">
                            ...
                            <div class="bm-form-group">
                                ...
                                <div class="bm-input-group">
                                    ...
                                    <input type="password" name="password" class="bm-input-text bm-input-text--long">
                            ...
                            <div class="bm-form-group">
                                ...
                                <label for="agree">I Agree to
                                    <a href="{{route('website.legal.terms')}}" target="_blank" class="bm-link">Terms of Use</a>
                                                   and
                                    <a href="{{route('website.legal.privacy')}}" target="_blank" class="bm-link">Privacy Policy</a>
                                </label>
