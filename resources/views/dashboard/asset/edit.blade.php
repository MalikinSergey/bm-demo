...
@section('breadcrumbs')
    ...
    <li class="breadcrumb-item">
        <a href="{{route('dashboard.asset.index')}}">Assets</a>
    </li>
...
@section('content')
    ...
    {!! Form::model($asset, ['route' => [ 'dashboard.asset.update', $asset->id ], 'method' => 'PUT' ]) !!}
    ...
    <div class="row justify-content-md-center">
        ...
        <div class="col-8">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <span class="display-3 d-block mb-3 text-center">{{$asset->name}}</span>
